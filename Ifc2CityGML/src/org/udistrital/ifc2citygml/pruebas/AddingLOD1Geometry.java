...
public class AddingLOD1Geometry {
	...
	public static void main(String[] args) throws Exception {
		...
		CityGMLBuilder builder = ctx.createJAXBBuilder();
		...
		CityGMLReader reader = in.createCityGMLReader(new File("C:\\Actual 2011\\IFC - cityGML\\software\\citygml4j-1_0-java5\\citygml4j-1.0-java5\\samples\\datasets\\LOD2_Buildings_v100.xml"));
